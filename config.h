...
static const char dmenufont[]       = "Source Code Pro:pixelsize=12:antialias=true:autohint=true";
...
static const char *tooglekbdcmd[] = { "fb-toogle-kbd-layout", NULL };
...
static Key keys[] = {
    ...
    { MODKEY,                       XK_F12,    spawn,          {.v = tooglekbdcmd } },
};
